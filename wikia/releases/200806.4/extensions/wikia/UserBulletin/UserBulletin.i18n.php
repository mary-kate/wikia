...
function efWikiaUserBulletin() {
	...
	return array(
		'en' => array(
			...
			'bulletin_poke' => 'nudged [{{PROFILEJSONPATH}}profile.html?user={{#BULLETINNAME:$1}} $1]',
			'bulletin_pokeback' => 'nudged [{{PROFILEJSONPATH}}profile.html?user={{#BULLETINNAME:$1}} $1] back',
