...
//require_once("$IP/extensions/MainPage_Entertainment.php");
 ...
 // $s .= "<td><span style='font-size:14pt; font-weight:bold; color:#285C98;'>search</span></td>";
  ...
  $s .= '<a href="index.php?title=Main_Page"><img src="images/games/logo.png" alt="games.wikia" border="0"/></a>';
  $s .= '</td>';
  ...
  $s .= '<tr>';
  $s .= '<td></td>';
  $s .= '<td width="190"><img src="images/games/righttop.gif" alt="main logo" border="0"/></td>';
  $s .= '</tr>';
  $s .= '<tr>';
  $s .= '<td class="leftmiddle">';
  $s .= '<table border="0" cellpadding="0" cellspacing="0" width="100%">'; //t5
  $s .= '<tr>';
  $s .= '<td width="70"><a href="index.php?title=Main_Page">home</a></td>';
  $s .= '<td><a href="index.php?title=PC">pc</a></td>';
  $s .= '<td><a href="index.php?title=PS2">ps2</a></td>';
  $s .= '<td><a href="index.php?title=PSP">psp</a></td>';
  $s .= '<td><a href="index.php?title=PS3">ps3</a></td>';
  $s .= '<td width="60"><a href="index.php?title=XBox">xbox</a></td>';
  $s .= '<td><a href="index.php?title=Wii">wii</a></td>';
  $s .= '<td width="100"><a href="index.php?title=Gamecube">gamecube</a></td>';
  $s .= '<td><a href="index.php?title=gba">gba</a></td>';
  $s .= '<td><a href="index.php?title=ds">ds</a></td>';
  $s .= '<td width="85"><a href="index.php?title=mobile">mobile</a></td>';
  ...
  $s .= '<td class="rightbottom"><img src="images/games/rightbottom.gif" alt="main logo" border="0"/></td>';
  $s .= '</tr>';
  $s .= '</table>'; //et4
  ...
  if( $wgUser->isLoggedIn() ) {
  $s .= '<td width="22"><img src="images/games/edit.gif" alt="edit" border="0"/></td>';
  $s .= '<td>' . $this->editThisPage() . '</td>';
  if ( $wgTitle->userCanMove() ) {
  $s .= '<td width="22"><img src="images/games/move.gif" alt="move" border="0"/></td>';
  $s .= '<td>' . $this->moveThisPage() . '</td>';
  }
  $s .= '<td width="22"><img src="images/games/history.gif" alt="history" border="0"/></td>';
  $s .= '<td>' . $this->historyLink()  . '</td>';
  $s .= '<td width="22"><img src="images/games/whatlinkshere.gif" alt="what links here" border="0"/></td>';
  $s .= '<td>' . $this->whatLinksHere()  . '</td>';
  if( $tns == NS_USER || $tns == NS_USER_TALK ) {
  $link = $wgTitle->getTalkPage();
  $s .= '<td width="22"><img src="images/games/discuss.gif" alt="discuss" border="0"/></td>';
  $s .= '<td>' . $this->makeLinkObj( $link, 'talk page')  . '</td>';
  $id=User::idFromName($wgTitle->getText());
  if ($id != 0) {
  $s .= '<td width="22"><img src="images/games/usercontribution.gif" alt="user contributions" border="0"/></td>';
  $s .= '<td>' . $this->userContribsLink()  . '</td>';
  if( $this->showEmailUser( $id ) ) {
  $s .= '<td width="22"><img src="images/games/email.gif" alt="email user" border="0"/></td>';
  $s .= '<td>' . $this->emailUserLink()  . '</td>';
  }
  }
  }
  if ( $wgUser->isAllowed('delete') && NS_SPECIAL !== $wgTitle->getNamespace()) {
  $s .= '<td width="22"><img src="images/games/delete.gif" alt="delete" border="0"/></td>';
  $s .= '<td>' . $this->deleteThisPage() . '</td>';
  }
  if ( $wgUser->isAllowed('protect') && NS_SPECIAL !== $wgTitle->getNamespace() ) {
  $s .= '<td width="22"><img src="images/games/protect.gif" alt="protect" border="0"/></td>';
  ...
  $s .= '<td width="22"><img src="images/games/arrow.gif" alt="help" border="0"/></td>';
  }
  $s .= '<td width="22"><img src="images/games/edit.gif" alt="edit" border="0"/></td>';
  $s .= '<td>' . $this->editThisPage() . '</td>';
  $s .= '<td width="22"><img src="images/games/history.gif" alt="history" border="0"/></td>';
  $s .= '<td>' . $this->historyLink()  . '</td>';
  $s .= '<td width="22"><img src="images/games/help.gif" alt="help" border="0"/></td>';
...
$output .= '</tr>';
$output .= '<tr>';
$output .= '<td width="22"><img src="../images/games/pencilmain.gif" alt="pencil main"></td>';
...
$output .= '</tr>';
$output .= '<tr>';
$output .= '<td colspan="3" class="mainpagelinks"><a href="index.php?title=Add_Tip_Or_Trick">add tip or trick</a></td>';
$output .= '</tr>';
$output .= '</table>';
...
$output .= '<table width="410" cellpadding="2" cellspacing="2" border="0" align="center">';
$output .= '<tr>';
$output .= '<td class="title" xstyle="color:#FFFFFF;background-image:url(\'../../images/games/background.gif\');">';
$output .= 'new opinions';
$output .= '</td>';
$output .= '</tr>';
$output .= '<tr>';
...
$output .= '<table width="410" cellpadding="2" cellspacing="2" border="0" align="center">';
$output .= '<tr>';
$output .= '<td class="title" style="padding-bottom:5px;">top rated games</td>';
$output .= '</tr>';
$output .= '<td>';
$output .= '<div id="destinationview">';
$list1 = new ListPages();
$list1->setCategory("Games");
