...
class SkinPSN extends Skin {
	...
	function getUserStyles() {
		...
		$s .= "<!--[if IE]><style type=\"text/css\" media=\"all\">@import \"/skins/common/wikiany/css/psn_IE.css\";</style><![endif]-->\n";
		return $s;
	...
	function getLeaderboard(){
		$output = "<!--/* OpenX Javascript Tag v2.5.60-beta */-->
	...
	function doBeforeContent() {
		...
		$output .= "<div id=\"container\">
			...
			<div id=\"site-header\">
				<div id=\"site-logo\">
					<a href=\"".$main_page_link->escapeFullURL()."\" rel=\"nofollow\"><img src=\"{$wgUploadPath}/common/logo.gif?1\" border=\"0\" alt=\"\"/></a>
				</div>
			</div>";
