...
class SkinEntertainment extends Skin {
  
//require_once("$IP/extensions/MainPage_Entertainment.php");
	
  #set stylesheet
  function getStylesheet() {
    return "common/Entertainment.css";
  }
 ...
 // $s .= "<td><span style='font-size:14pt; font-weight:bold; color:#285C98;'>search</span></td>";
  ...
  $s .= '<a href="index.php?title=Main_Page"><img src="images/entertainmentlogo.png" alt="entertainment.wikia" border="0"/></a>';
  $s .= '</td>';
  ...
  $s .= '<tr>';
  $s .= '<td></td>';
  $s .= '<td width="190"><img src="images/entertainment/righttop.gif" alt="main logo" border="0"/></td>';
  $s .= '</tr>';
  $s .= '<tr>';
  ...
  $s .= '<td><a href="index.php?title=Gossip">gossip</a></td>';
  $s .= '<td><a href="index.php?title=TV">television</a></td>';
  $s .= '<td><a href="index.php?title=Movies">movies</a></td>';
  $s .= '<td><a href="index.php?title=Broadway">broadway</a></td>';
  $s .= '<td><a href="index.php?title=Comedy">comedy</a></td>';
  ...
  $s .= '<td class="rightbottom"><img src="images/entertainment/rightbottom.gif" alt="main logo" border="0"/></td>';
  $s .= '</tr>';
  $s .= '</table>'; //et4
  ...
  if( $wgUser->isLoggedIn() ) {
  $s .= '<td width="22"><img src="images/entertainment/edit.gif" alt="edit" border="0"/></td>';
  $s .= '<td>' . $this->editThisPage() . '</td>';
  if ( $wgTitle->userCanMove() ) {
  $s .= '<td width="22"><img src="images/entertainment/move.gif" alt="move" border="0"/></td>';
  $s .= '<td>' . $this->moveThisPage() . '</td>';
  }
  $s .= '<td width="22"><img src="images/entertainment/history.gif" alt="history" border="0"/></td>';
  $s .= '<td>' . $this->historyLink()  . '</td>';
  $s .= '<td width="22"><img src="images/entertainment/whatlinkshere.gif" alt="what links here" border="0"/></td>';
  $s .= '<td>' . $this->whatLinksHere()  . '</td>';
  if( $tns == NS_USER || $tns == NS_USER_TALK ) {
  $link = $wgTitle->getTalkPage();
  $s .= '<td width="22"><img src="images/entertainment/discuss.gif" alt="discuss" border="0"/></td>';
  $s .= '<td>' . $this->makeLinkObj( $link, 'talk page')  . '</td>';
  $id=User::idFromName($wgTitle->getText());
  if ($id != 0) {
  $s .= '<td width="22"><img src="images/entertainment/usercontribution.gif" alt="user contributions" border="0"/></td>';
  $s .= '<td>' . $this->userContribsLink()  . '</td>';
  if( $this->showEmailUser( $id ) ) {
  $s .= '<td width="22"><img src="images/entertainment/email.gif" alt="email user" border="0"/></td>';
  $s .= '<td>' . $this->emailUserLink()  . '</td>';
  }
  }
  }
  if ( $wgUser->isAllowed('delete') && NS_SPECIAL !== $wgTitle->getNamespace()) {
  $s .= '<td width="22"><img src="images/entertainment/delete.gif" alt="delete" border="0"/></td>';
  $s .= '<td>' . $this->deleteThisPage() . '</td>';
  }
  if ( $wgUser->isAllowed('protect') && NS_SPECIAL !== $wgTitle->getNamespace() ) {
  $s .= '<td width="22"><img src="images/entertainment/protect.gif" alt="protect" border="0"/></td>';
  ...
  $s .= '<td width="22"><img src="images/entertainment/arrow.gif" alt="help" border="0"/></td>';
  }
  $s .= '<td width="22"><img src="images/entertainment/edit.gif" alt="edit" border="0"/></td>';
  $s .= '<td>' . $this->editThisPage() . '</td>';
  $s .= '<td width="22"><img src="images/entertainment/history.gif" alt="history" border="0"/></td>';
  $s .= '<td>' . $this->historyLink()  . '</td>';
  $s .= '<td width="22"><img src="images/entertainment/help.gif" alt="help" border="0"/></td>';
...
$output .= '</tr>';
$output .= '<tr>';
$output .= '<td width="22"><img src="../images/entertainment/pencilmain.gif" alt="pencil main"></td>';
...
$list1 = new ListPages();
$list1->setCategory("TV Shows,Movies");
