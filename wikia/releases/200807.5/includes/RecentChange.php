...
class RecentChange
{
	...
	function save()
	{
		global $wgLocalInterwiki, $wgPutIPinRC, $wgRC2UDPAddress, $wgRC2UDPPort, $wgRC2UDPPrefix, $wgRC2UDPEnabled;
		...
		if ( $wgRC2UDPEnabled && $wgRC2UDPAddress && function_exists ( 'socket_create' ) ) {
