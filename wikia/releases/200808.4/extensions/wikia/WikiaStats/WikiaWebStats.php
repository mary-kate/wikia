...
function wfWikiaWebStatsScript($this, $bottomScriptText) {
	...
	if(!empty($wgCityId) && !empty($wgDotDisplay)) {
		...
		$bottomScriptText = '<script type="text/javascript">/*<![CDATA[*/document.write("<img src=\"'.$url.'"+((typeof document.referrer != "undefined") ? "&amp;r="+escape(document.referrer) : "")+"&amp;cb="+(new Date).valueOf()+"\" width=\"1\" height=\"1\" border=\"0\" />");/*]]>*/</script><noscript><img src="'.$url.'" width="1" height="1" border="0" /></noscript>';
	}
	return true;
}
