...
'activeusersempty' => 'Este wiki aún no tiene ediciones de usuarios registrados',
'activeusersintro' => 'Esta página muestra la lista de usuarios que han realizado ediciones en este wiki',
'activeusersline' => '* [[$1]] ([[Special:Contributions/$2|contribuciones]]; última edición: $3)',
'activeusersnext' => '$1 siguientes  >>',
...
'addedwatchtext' => 'La página «[[:$1]]» ha sido añadida a tu [[Special:Watchlist|lista se seguimiento]]. 
Los cambios futuros en esta página y su página de discusión asociada se indicarán ahí, y la página aparecerá \'\'\'en negritas\'\'\' en la [[Special:Recentchanges|lista de cambios recientes]] para hacerla más fácil de detectar. 

Cuando quieras eliminar la página de tu lista de seguimiento, presiona "Dejar de vigilar" en el menú.',
'addimagetag' => 'Etiqueta esta imagen',
'addingtag' => 'Añadiendo etiqueta...',
'addmessage' => 'Dejar mensaje',
'addsection' => 'Dejar un mensaje',
'addtagsuccess' => 'Etiqueta añadida',
...
'allmessagesnotsupportedUI' => 'Tu idioma de interfaz actual (<b>$1</b>) no está disponible en Special:AllMessages en este sitio.',
...
'avatarupload_large' => 'Grande, 75x75 px',
...
Puede deberse a que intentaste buscar una palabra de menos de tres letras, lo que todavía no es posible.
...
'block-log-flags-autoblock' => 'autobloqueos activados',
...
'canteditneedloginmessage' => 'No puedes editar esta página. Puede deberse a que necesites iniciar sesión para etiquetar imágenes. ¿Quieres iniciar sesión?',
'canteditothermessage' => 'No puedes editar esta página, ya sea porque no tienes privilegios de usuario o porque esta página ha sido protegida por otras razones. Para más información, puedes ver http://es.wikia.com/wiki/Protección',
'captcha-blank' => 'Si quieres borrar esta página, contacta a un [[Special:Listusers/sysop|administrador]]. Blanquear una página no la borra. Para confirmar que quieres blanquear esta página, escribe lo que aparece en esta imagen. Esta medida es de protección contra bots de blanqueo<br /> ([[Special:Captcha/help|más información]])',
'captcha-createaccount-fail' => 'Falta el código de confirmación, o éste es incorrecto.',
'captcha-createaccount' => 'Como medida de protección contra el spam automatizado, es necesario que escribas lo que aparece en esta imagen para registrar una cuenta:<br /> ([[Special:Captcha/help|Más información]])',
...
'captcha-move' => 'Como medida de protección contra el vandalismo, es necesario que escribas lo que aparece en la imagen.<br /> ([[Special:Captcha/help|más información]])',
'captcha-short' => 'Tu edición incluye hipervínculos. Como protección contra el spam automatizado debes escribir lo que aparece en la siguiente imagen:<br /> ([[Special:Captcha/help|Más información]])',
'captchahelp-text' => 'Los sitios web que aceptan contribuciones del público, como este wiki, son a menudo objeto de abusos por spammers que utilizan programas para incluir automáticamente sus enlaces a varios sitios web. Si bien estos enlaces pueden quitarse, son una gran molestia. En algunas ocasiones, especialmente cuando añadas nuevos enlaces a una página, el wiki te mostrará una imagen de texto coloreado o distorsionado y te pedirá que escribas las palabras que muestra. Dado que esta es una tarea difícil de automatizar, permite a la mayoría de las personas enviar sus textos, a la vez que detiene a la mayoría de los spammers y otros robots de ataque. Desafortunadamente, la medida puede se un inconveniente para usuarios con visión limitada o a aquellos que utilizan navegadores de texto o de voz. Hasta el momento, no tenemos de una alternativa sonora disponible. Por favor, contacta a los administradores del wiki para que te brinden asistencia si la medida te impide realizar contribuciones legítimas. Haz clic en el botón \'Atrás\' de tu navegador para volver a la página de edición.',
'captchahelp-title' => 'Información sobre el captcha',
'cascadeprotected' => 'Esta página ha sido protegida para su edición, porque está incluida en las siguientes página, que están protegidas con la opción de "cascada":',
'cascadeprotectedwarning' => '\'\'\'Aviso:\'\'\' Esta página está protegida, sólo los administradores pueden editarla porque está incluida en las siguientes páginas protegidas con la opción de \'\'cascada\'\':',
...
'categorytree-show-list' => 'Mostrar como una lista',
'categorytree-show-tree' => 'Mostrar como un árbol',
'categorytree-tab' => 'Árbol',
'categorytree-too-many-subcats' => 'Hay demasiadas subcategorías para ser desplegadas como un árbol.',
...
Con las miles de comunidades que existen en Wikia, hay muchas formas de divertirse aquí. Te recomendamos tomar algo de tu tiempo conociendo Wikia, ya sea visitando su página principal (es.wikia.com), siguiendo un tutorial (<http://es.wikia.com/wiki/Ayuda:Tutorial_1>), leyendo artículos interesantes y geniales, escribiendo contenidos en tu tema favorito, o conociendo a otros miembros de la comunidad.
...
Este enlace de confirmación expirará en 7 días.

(Par tu información, este nombre de usuario fue creado por la siguiente dirección: $1)

¡Esperamos verte en Wikia!
...
'contactproblem' => 'Asunto',
'contactproblemdesc' => 'Mensaje',
'contactrealname' => 'Tu nombre',
'contactsubmitcomplete' => 'Gracias por contactar a Wikia.',
'contactwikiname' => 'Nombre del wiki',
'contris' => 'Contribuciones',
'contris_s' => 'Contribuciones',
'copyrightpage' => 'Project:Derechos de autor',
'copyrightpagename' => 'Derechos de autor de {{SITENAME}}',
'copyrightwarning' => '{| style="width:100%; padding: 5px; font-size: 95%;"
|- valign="top"
|
Todas las contribuciones a {{SITENAME}} se consideran publicadas bajo la  $2 (ver detalles en $1).<br/>
Tus cambios podrán ser vistos en forma inmediata. \'\'\'Por favor, añade un resumen de tus cambios en la caja de abajo.\'\'\'

<div style="font-weight: bold; font-size: 120%;">¡No ingreses textos o imágenes que posean derecho de autor sin el permiso correspondiente!</div>

| NOWRAP |
* \'\'\'[[Special:Upload|Subir]]\'\'\' imágenes al wiki.
* No olvides \'\'\'[[Special:Categories|categorizar]] las páginas\'\'\'!
* Para realizar pruebas, por favor utiliza la Zona de Pruebas.\'\'\'
<div><small>\'\'[[MediaWiki:Copyrightwarning|Ver esta plantilla]]\'\'</small></div>
|}',
...
'createpage_button' => 'Crear un nuevo artículo',
...
'createpage_hide_cloud' => '[ocultar la nube de categorías]',
...
'createpage_loading_mesg' => 'Cargando... espera por favor...',
...
'createpage_show_cloud' => '[Mostrar la nube de categorías]',
...
'createwiki_welcomebody' => 'Hola $1, la Wikia que solicitaste ya está disponible en <$0>. ¡Esperamos verte editando ahí muy pronto! Hemos añadido algunas informaciones y consejos en tu página de discusión de usuario (<$4>) para ayudarte a comenzar. Si tienes cualquier tipo de problema, puedes solicitar ayuda de la comunidad en <http://es.wikia.com/wiki/Forum:Mesa_de_ayuda>, o a través de correo electrónico a community@wikia.com. También puedes visitar nuestros canales de IRC en vivo #wikia-es y #wikia (pluriligüe) con tu programa de IRC o por web en <http://irc.wikia.com>. Si tienes preguntas o dudas, puedes contactarme directamente por correo electrónico o en mi página de discusión. ¡Buena suerte con el proyecto! $2 Equipo comunitario de Wikia <http://www.wikia.com/wiki/User:$3>',
'createwiki_welcomesubject' => '$0 ha sido creado!',
'createwiki_welcometalk' => 'Hola \'\'\'$0\'\'\'. ¡Estamos muy felices de tener a \'\'\'$3\'\'\' como parte de la comunidad de Wikia!

Comenzar un nuevo wiki puede ser abrumante... pero no te preocupes, ¡el [[w:c:es.wikia:Equipo comunitario|equipo comunitario de Wikia]] está aquí para ayudarte! :-) 

Hemos recopilado algunas guias que pueden ser útiles en el inicio del wiki. Dicen que la imitación es la mejor forma de adulación, así que te recomendamos dar un vistazo a otros wikis de [[w:c:es.wikia:Wikia|Wikia]] para obtener ideas de formatos, formas de organizar tu contenido, etc. ¡En Wikia somos una gran familia y a lo que le damos más importancia es a pasarlo bien! 
* Nuestra guía para [[Ayuda:Comenzando este wiki|comenzar este wiki]] te brinda 5 cosas que puedes hacer ahora mismo para dejar tu wiki listo para el éxito. 
* También hemos recopilado algunos [[Help:Consejos al comenzar un wiki|consejos al comenzar un wiki]] que puede darte una visión más profunda a alguna de las cosas importantes que deberías considerar cuando construyes un wiki 
* Si los wikis son nuevos para ti, te recomendamos revisar nuestras [[Ayuda:Preguntas frecuentes|preguntas frecuentes para usuarios nuevos]]. 

Si necesitas ayuda (y créeme que todos la necesitamos alguna vez), puedes acceder a nuestra completa ayuda en profundidad en [[w:c:es.wikia:Ayuda:Contenidos|nuestra sección de ayuda]] en Wikia Central, visitar el [[w:c:es.wikia:Forum:Mesa de ayuda|foro Mesa de ayuda de Wikia]], o enviarnos un correo electrónico a través de nuestro [[Special:Contact|formulario de contacto]]. Adicionalmente, puedes visitar nuestro [http://irc.wikia.com canal de chat en vivo] #wikia-es y #wikia (plurilingüe, pero predominantemente en inglés) en cualquier momento. Una gran cantidad de "Wikianos" veteranos están siempre ahí, por lo que es un buen lugar si necesitas ayuda rápida o simplemente hacer amigos. 

Ahora ¡a editar! ¡Esperamos que este proyecto tenga un fututo próspero! Los mejores deseos, [[User:$1|$2]]',
'createwikiaddtnl' => 'Información adicional',
'createwikidesc' => 'Descripción del wiki',
'createwikilang' => 'Idioma predeterminado para este wiki',
'createwikimailsub' => 'Solicitud para una nueva Wikia',
'createwikiname' => 'Nombre para el wiki',
'createwikinamevstitle' => 'El nombre del wiki se diferencia del título del wiki en que el nombre es el que será usado para determinar la URL predeterminada. Por ejemplo, el nombre "starwars" estaría disponible en http://starwars.wikia.com/. El título del wiki puede contener espacio, el nombre sólo debe contener letras y/o números.',
'createwikipagetitle' => 'Solicita un nuevo wiki',
'createwikisubmitcomplete' => 'Tu envío está completo. Si entregaste una dirección de correo electrónico, serás contactado en relación al nuevo wiki.

Gracias por utilizar {{SITENAME}}.',
'createwikitext' => 'Puedes solicitar la creación de un nuevo wiki en esta página. Sólo rellena el formulario',
'createwikititle' => 'Título para el wiki',
...
'deleteimgcompletely' => 'Borrar todas las revisiones de este archivo',
...
'done_button' => 'Etiqueta añadida',
'doubleredirectstext' => 'Cada fila contiene enlaces al segundo y tercer redirect, así como la primera línea del segundo redirect, en la que usualmente se encontrará el artículo "real" al que el primer redirect debería apuntar.',
'dpl2_articlecount' => 'Hay $1 {{PLURAL:$1|artículo|artículos}} en este encabezado',
'dpl2_debug_15' => 'ATENCIÓN: ¡Sin resultados!',
'edit-summary' => 'Editar resumen',
'edit' => 'Editar esta página',
'edit_this_page' => '<a href="$1">Edita este artículo</a>',
'editcount' => 'Contador de ediciones',
'editcount_submit' => 'Consultar',
'editcount_username' => 'Usuario:',
'editedrecently' => 'Editada recientemente por',
...
'editundo' => 'deshacer',
'emailccme' => 'Enviarme una copia de mi mensaje por correo electrónico.',
'emailccsubject' => 'Copia de tu mensaje para $1: $2',
'emailnotauthenticated' => 'Aún no has confirmado tu dirección de correo.
Hasta que lo hagas, las siguientes funciones no estarán disponibles.',
'emailuser' => 'Enviar e-mail al usuario',
'enotif_body' => 'Estimado/a $WATCHINGUSERNAME,

Una de las páginas de tu lista de seguimiento en {{SITENAME}} ha tenido cambios.

Puedes ver su versión actual en $PAGETITLE_URL

$NEWPAGE

El resumen de edición es: "$PAGESUMMARY"

Esperamos que sigas visitando y editando {{SITENAME}}.
___________________________________________________________________________

* ¿Quieres especificar qué correos electrónicos recibes de Wikia? Visita: {{fullurl:{{ns:special}}:Preferences}}.

* Para ver los nuevos wikis creados esta semana, puedes visitar <http://www.wikia.com/wiki/New_wikis_this_week>.',
'enotif_lastvisited' => 'Visita $1 para ver todos los cambios en esta página desde tu última visita.',
'excontentauthor' => 'El contenido era: \'$1\' (y el único autor fue \'[[Special:Contributions/$2|$2]]\')',
'export-addcat' => 'Añadir',
'export-addcattext' => 'Añadir páginas de la categoría:',
'export-download' => 'Grabar como archivo',
'exporttext' => 'Puedes exportar el texto y el historial de edición de una página en particular o de un conjunto de páginas a un texto XML. Este texto podría posteriormente importarse en otro wiki que utilice MediaWiki, utilizando la [[Special:Import|página de importación]].
...
En el último caso puedes usar un enlace, por ejemplo [[Special:Export/{{Mediawiki:Mainpage}}]] para {{Mediawiki:Mainpage}}.',
...
'file-nohires' => '<small>No existe una resolución mayor disponible.</small>',
...
'filetype-badmime' => 'No se permite la subida de archivos del tipo MIME "$1"',
'filetype-badtype' => '\'\'\'".$1"\'\'\' es un tipo de archivo no permitido
: Lista de tipos de archivo permitidos: $2',
...
Por favor sigue este enlace: $2 a la página de descripción y rellena
la información acerca del archivo, de dónde viene, cuándo fue
creado y por quién, y cualquier otra cosa que puedas saber a su respecto.
Si es una imagen, puedes insertarla de esta forma: <tt><nowiki>[[</nowiki>{{ns:image}}<nowiki>:$1|thumb|Descripción]]</nowiki></tt>',
...
'footer_About_Wikia' => '[http://es.wikia.com/wiki/Acerca_de_Wikia Acerca de Wikia]',
'footer_Advertise_on_Wikia' => '[http://es.wikia.com/wiki/Publicidad Anuncia en Wikia]',
'footer_Contact_Wikia' => '[http://es.wikia.com/wiki/Contáctanos Contacta a Wikia]',
'footer_Terms_of_use' => '[http://www.wikia.com/wiki/Términos_de_uso Términos de uso]',
'forum-url' => 'Forum:Index',
'forum_by' => 'por',
'forum_edited' => '- Última edición',
'forum_never' => 'Nunca',
'forum_toofew' => 'Foro DPL: ¡Muy pocas categorías!',
'forum_toomany' => 'Foro DPL: ¡Demasiadas categorías!',
...
'giverollback-change' => 'Cambiar el estado:',
'giverollback-comment' => 'Comentario:',
'giverollback-grant' => 'Otorgar',
'giverollback-granted' => '[[User:$1|$1]] ahora tiene derechos de reversión.',
'giverollback-hasrb' => '[[User:$1|$1]] tiene derechos de reversión.',
'giverollback-header' => '\'\'\'Un burócrata local puede usar esta página para otorgar o revocar [[Ayuda:Reversión|derechos de reversión]] a otra cuenta de usuario.\'\'\'<br />Puede utilizarse para permitir que los no administradores puedan revertir vandalismo rápidamente. Esto puede realizarse de acuerdo con las políticas en aplicación.',
'giverollback-logentrygrant' => 'otorgados derechos de reversión a [[$1]]',
'giverollback-logentryrevoke' => 'revocados derechos de reversión de [[$1]]',
'giverollback-logpage' => 'Registro de derechos de reversión',
'giverollback-logpagetext' => 'Este es un registro de cambios de derechos de [[Ayuda:Reversión|reversión]] de no administradores.',
'giverollback-norb' => '[[User:$1|$1]] no tiene derechos de reversión.',
'giverollback-revoke' => 'Revocar',
'giverollback-revoked' => '[[User:$1|$1]] ya no tiene derechos de reversión.',
'giverollback-search' => 'Buscar',
'giverollback-sysop' => '[[User:$1|$1]] es administrador y ya tiene permisos de reversión.',
'giverollback-toonew' => '[[User:$1|$1]] es demasiado nuevo, por lo que no se le pueden asignar derechos de reversión.',
'giverollback-username' => 'Nombre de usuario:',
'giverollback' => 'Otorgar o revocar derechos de reversión',
...
'monaco-articles-on' => '$1 artículos en este wiki<br />',
'monaco-category-list' => '*w:Category:Hubs|más wikis
**w:Gaming|Juegos
**w:Entertainment|Entretenimiento
**w:Sci-Fi|Ciencia Ficción
**w:Big_wikis|Grandes wikis
**w:Hobbies|Pasatiempos
**w:Technology|Tecnología',
'monaco-custom' => 'Personalizado',
'monaco-edit-this-menu' => 'Edita este menú',
'monaco-footer-links' => '*Hubs
**w:Gaming|Juegos
**w:Entertainment|Entretenimiento
**w:Sci-Fi|Ciencia Ficción
**w:Music|Música
**w:Big_wikis|Wikis más grandes
**w:Hubs|ver todos...
*Destacados
**http://www.armchairgm.com|ArmchairGM
**http://foodie.wikia.com|Foodie
*Wikia está contratando
...
**w:Hiring|Otros puestos',
'monaco-footer-wikia-links' => '*http://es.wikia.com/wiki/Acerca_de_Wikia|Acerca de Wikia
*http://es.wikia.com/wiki/Cont%C3%A1ctanos|Contacta a Wikia
*http://es.wikia.com/wiki/T%C3%A9rminos_de_uso|Términos de uso
*http://www.mediawiki.org/|MediaWiki
*http://www.gnu.org/copyleft/fdl.html|GFDL
*http://es.wikia.com/wiki/Publidad|Anuncia en Wikia
*http://es.wikia.com/wiki/T%C3%A9rminos_de_uso#Recopilaci.C3.B3n_de_informaci.C3.B3n_personal|Política de privacidad',
'monaco-latest-item' => '$1 por $2',
'monaco-latest' => 'Últimos cambios',
'monaco-related-communities' => '*w:Entertainment|Entretenimiento|Programas de TV, películas, dibujos animados y cómics.
*w:Gaming|Juegos|Saca provecho de tu juego con los wikis de videojuego en Wikia
*w:Sci-Fi|Ciencia Ficción|Explora el mundo del futuro.
*w:Big_wikis|Biggest Wikis|Ver los wikis de mayor tamaño en Wikia
*w:Hubs|Ver todo...',
'monaco-sidebar' => '*mainpage|{{SITENAME}}
*mainpage|Contenido destacado
...
*#category1#
*#category2#',
'monaco-toolbox' => '* Special:Random|randompage
...
* helppage|help',
'monaco-welcome-back' => 'Bienvenido de nuevo, <b>$1</b><br />',
'monaco-whos-online' => 'Quién está conectado',
...
'multipleupload-text' => 'Puedes subir múltiples archivos aquí

Escoge \'Navegar\' y selecciona cada archivo que quieras subir. Puedes subir desde uno a $1 archivos por vez.

Puedes ingresae un \'\'\'Nombre de archivo de destino\'\'\' opcional y colocar un \'\'\'Resumen\'\'\' describiendo tu archivo.

Los archivos inapropiados será borrados inmediatamente, como se señala en la [[{{MediaWiki:Multipleupload-page}}|política de borrado de archivos]].',
...
'noexactmatch' => 'No existe una página llamada "$1" en {{SITENAME}}, pero si quieres, puedes [[:$1|crearla]].',
'nospecialpagetext' => 'Has requerido una página especial que no existe en {{SITENAME}}. Puedes encontrar una lista de todas las páginas especiales en [[{{ns:-1}}:Specialpages]].',
...
'rcnote' => 'Abajo {{PLURAL:$1|está \'\'\'1\'\'\' cambio|están los últimos \'\'\'$1\'\'\' cambios}}  en {{PLURAL:$2|el último día|en los últimos \'\'\'$2\'\'\' días}}, actualizados al $3',
'rcshowhideenhanced' => '$1 cambios recientes realzados',
'recentchangestext' => '<span style="float:right;"><small>\'\'[[MediaWiki:Recentchangestext|Ver esta plantilla]]\'\'</small></span>
