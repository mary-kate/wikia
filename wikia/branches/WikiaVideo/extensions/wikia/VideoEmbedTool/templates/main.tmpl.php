	...
	<tr id="VideoEmbedAdd">
		<td>
			...
			if( !$wgUser->isAllowed( 'upload' ) ) {
				...
				?>
					<form onsubmit="return AIM.submit(this, VET_preQueryCallback)" action="<?= $wgScriptPath ?>/index.php?action=ajax&rs=VET&method=insertVideo" id="VideoEmbedForm" method="POST">
