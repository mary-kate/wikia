	...
	if(count($videos) > 0) {
		...
		if (count($videos) < 4) { // fill up 
			for($i = count($videos); $i < 4; $i++) {
				$out .= '<td><div class="gallerybox" style="width: 335px;"><div class="thumb" style="padding: 13px 0; width: 330px;"><div style="margin-left: auto; margin-right: auto; width: 300px; height: 250px;"><a href="#" class="bigButton"><big>' . wfMsg( 'wikiavideo-create' ) . '</big></a></div></div><div class="gallerytext"></div></div></td>';
				if($i%2 == 1) {
					$out .= '</tr><tr>';
				}
			}
