	...
	function confirmDelete( $reason ) {
		...
		$form = Xml::openElement( 'form', array( 'method' => 'post', 'action' => $this->mTitle->getLocalURL( 'action=delete' ), 'id' => 'deleteconfirm' ) ) .
			...
			<tr id=\"wpDeleteReasonRow\">
				...
				"</td>
				<td>" .
					Xml::input( 'wpReason', 60, $reason, array( 'type' => 'text', 'maxlength' => '255', 'tabindex' => '2', 'id' => 'wpReason' ) ) . Xml::element( 'input', array( 'type' => 'button', 'id' => 'wpClearReason', 'name' => 'wpClearReason', 'value' => wfMsg( 'delete-clear-reason' ) ) ) .
				"</td>
			</tr>
			<tr>
				<td></td>
