...
function UserBoxesHook( $input, $args, &$parser ){	
		global $wgOut, $IP, $wgParser, $wgUser, $wgTitle, $wgMemc, $wgUserProfileDisplay, $wgMessageCache;
		global $wgFanBoxScripts, $wgFanBoxDirectory, $wgUploadPath, $wgStyleVersion, $wgExtensionsPath;
