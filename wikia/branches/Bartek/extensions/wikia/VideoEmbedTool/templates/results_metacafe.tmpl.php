...
?>
			<td style="width: 167px;"><a href="#" alt="<?= addslashes($results['item'][$i]['title']) ?>" title="<?= addslashes($results['item'][$i]['title']) ?>" onclick="VET_chooseImage(1, '<?= $results['item'][$i]['id'] ?>'); return false;"><img src="http://www.metacafe.com/thumb/<?=$results['item'][$i]['id']?>.jpg" /></a></td>
<?php
		}
	}
?>
