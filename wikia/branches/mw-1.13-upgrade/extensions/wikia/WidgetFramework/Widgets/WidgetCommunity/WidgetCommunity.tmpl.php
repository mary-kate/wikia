...
<?php
	...
	if($wgUser->isLoggedIn()) {
		...
		echo wfMsg('already_a_member') .' <a rel="nofollow" id="community_login" href="'. htmlspecialchars(Skin::makeSpecialUrl( 'Userlogin', 'returnto=' . $wgTitle->getPrefixedURL() )) .'" id="login">'. wfMsg('log_in') .'</a>';
	}
