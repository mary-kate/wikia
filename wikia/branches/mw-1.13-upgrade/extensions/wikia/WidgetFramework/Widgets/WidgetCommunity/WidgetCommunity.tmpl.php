...
<?php
	...
	if($wgUser->isLoggedIn()) {
		...
		echo '<a rel="nofollow" id="community_register" href="'. Skin::makeSpecialUrl( 'Userlogin', 'type=signup') .'" class="bigButton" style="margin-bottom: 5px;"><big>'. wfMsg('create_an_account') .'</big><small>&nbsp;</small></a>';
		echo '<br style="clear: left;"/>';
		echo wfMsg('already_a_member') .' <a rel="nofollow" id="community_login" href="'. Skin::makeSpecialUrl( 'Userlogin', 'returnto=' . $wgTitle->getPrefixedURL() ) .'" id="login">'. wfMsg('log_in') .'</a>';
	}
