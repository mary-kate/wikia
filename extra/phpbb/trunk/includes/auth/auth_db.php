...
{
  // We only want to get logged in through MediaWiki, so make a redirect to the wiki login page
...
function autologin_db()
{
  ...
  user_add(user_row_db($wgUser->getName(), " "));
...
*/
function user_row_db($username, $password)
{
...
*/
function validate_session_db(&$user_data)
{
  global $user, $session, $wgUser;
