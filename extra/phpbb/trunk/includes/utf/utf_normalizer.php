...
*/
if (!defined('UTF8_REPLACEMENT')) define('UTF8_REPLACEMENT', "\xEF\xBF\xBD");
if (!defined('UTF8_MAX')) define('UTF8_MAX', "\xF4\x8F\xBF\xBF");
if (!defined('UTF8_FFFE')) define('UTF8_FFFE', "\xEF\xBF\xBE");
if (!defined('UTF8_FFFF')) define('UTF8_FFFF', "\xEF\xBF\xBF");
if (!defined('UTF8_SURROGATE_FIRST')) define('UTF8_SURROGATE_FIRST', "\xED\xA0\x80");
if (!defined('UTF8_SURROGATE_LAST')) define('UTF8_SURROGATE_LAST', "\xED\xBF\xBF");
if (!defined('UTF8_HANGUL_FIRST')) define('UTF8_HANGUL_FIRST', "\xEA\xB0\x80");
if (!defined('UTF8_HANGUL_LAST')) define('UTF8_HANGUL_LAST', "\xED\x9E\xA3");
...
if (!defined('UNICODE_HANGUL_SBASE')) define('UNICODE_HANGUL_SBASE', 0xAC00);
if (!defined('UNICODE_HANGUL_LBASE')) define('UNICODE_HANGUL_LBASE', 0x1100);
if (!defined('UNICODE_HANGUL_VBASE')) define('UNICODE_HANGUL_VBASE', 0x1161);
if (!defined('UNICODE_HANGUL_TBASE')) define('UNICODE_HANGUL_TBASE', 0x11A7);
if (!defined('UNICODE_HANGUL_SCOUNT')) define('UNICODE_HANGUL_SCOUNT', 11172);
if (!defined('UNICODE_HANGUL_LCOUNT')) define('UNICODE_HANGUL_LCOUNT', 19);
if (!defined('UNICODE_HANGUL_VCOUNT')) define('UNICODE_HANGUL_VCOUNT', 21);
if (!defined('UNICODE_HANGUL_TCOUNT')) define('UNICODE_HANGUL_TCOUNT', 28);
if (!defined('UNICODE_HANGUL_NCOUNT')) define('UNICODE_HANGUL_NCOUNT', 588);
