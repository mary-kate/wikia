...
//$wiki_root_path = "http://fp010.qa.wikia.com/wiki/";
$wgWikiDomain = "$wgServer/wiki";
...
// macbre: prevents PHP notice in /includes/functions.php @ 3353
$wgWikicitiesNavLinks = array();
