...
//	'ACC_USER_ADMIN'			=> 'Usuario + Admin',
	...
	'MAX_CHARS'					=> 'Máx.',
	'MIN_CHARS'					=> 'Min.',
	'MIN_TIME_REG'				=> 'Tiempo mínimo para registrarse',
	'MIN_TIME_REG_EXPLAIN'		=> 'El formulario de registro no puede ser enviado antes de que haya pasado ese tiempo.',
	'MIN_TIME_TERMS'			=> 'Tiempo mínimo para aceptar los términos',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'La página de términos no puede ser saltada antes de que haya pasado ese tiempo.',
...
$lang = array_merge($lang, array(
	...
	'YES_JUMPBOX'					=> 'Habilite mostrar ventana emergente',
...
$lang = array_merge($lang, array(
	...
	'FORM_TIME_MAX_EXPLAIN'			=> 'El tiempo que un usuario tiene para enviar un formulario. Use -1 para desactivarlo. Note que un formulario puede volverse no válido si la sesión expira, por encima de esta configuració.',
	'FORM_TIME_MIN'					=> 'Tiempo mínimo para enviar formularios',
	'FORM_TIME_MIN_EXPLAIN'			=> 'Envíos más rápidos de este tiempo son ignorados por el foro. Use 0 para desactivarlo.',
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Si no es un usuario registrado, se creará, si es posible.',
));
