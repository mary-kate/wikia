...
$lang = array_merge($lang, array(
	...
	'ACP_INDEX'						=> 'Indice del Panel de Administración',
	...
	'LOGIN_ADMIN_SUCCESS'		=> 'Ha sido autentificado y será llevado al Panel de Administración',
	...
	'NO_PASSWORD_SUPPLIED'		=> 'Necesita introducir su contraseña para acceder al Panel de Administración.',	
	...
	'PIXEL'				=> 'px',
	'PROCEED_TO_ACP'	=> '%1$sIr al Panel de Administración%2$s',
...
$lang = array_merge($lang, array(
	...
	'LOG_DELETE_TOPIC'			=> '<strong>Borrado: tema</strong><br />» %1$s',
	'LOG_FORK'					=> '<strong>Copiado: tema</strong><br />» de %1$s',
	'LOG_LOCK'					=> '<strong>Bloqueado: tema</strong><br />» %1$s',
	'LOG_LOCK_POST'				=> '<strong>Bloqueado: mensaje</strong><br />» %1$s',
	'LOG_MERGE'					=> '<strong>Unidos: mensajes</strong> en tema<br />» %1$s',
	'LOG_MOVE'					=> '<strong>Movido tema</strong><br />» de %1$s',
	...
	'LOG_SPLIT_DESTINATION'		=> '<strong>Movido mensajes divididos</strong><br />» a %1$s',
	'LOG_SPLIT_SOURCE'			=> '<strong>Divididos: mensajes</strong><br />» de %1$s',

	'LOG_TOPIC_DELETED'			=> '<strong>Tema borrado</strong><br />» %s',
	...
	'LOG_UNLOCK'				=> '<strong>DesBloqueado: tema</strong><br />» %1$s',
	'LOG_UNLOCK_POST'			=> '<strong>DesBloqueado: mensaje</strong><br />» %1$s',
