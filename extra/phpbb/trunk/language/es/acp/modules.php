...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'		=> 'Aquí puede manejar toda clase de módulos. Por favor observe que el Panel de Administración tiene una estructura de menú de tres niveles (Categoría -> SubCategoría -> Módulo) por lo cual los otros tienen una estructura de menú de dos niveles (Categoría -> Módulo) la cual debe ser respetada. Por favor dese cuenta que puede bloquearse usted a si mismo si deshabilita o borra el módulo de administración de módulos.',
