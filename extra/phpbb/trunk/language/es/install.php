...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_PM_COUNT'	=> 'Imposible seleccionar carpeta contador de pm.',
...
// TODO: Write some explanatory introduction text
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Su viejo índice de búsqueda no fue convertido. Las búsquedas arrojarán un resultado vacío. Para crear nuevos índices de búsqueda vaya al Panel de Administración, seleccione Mantenimiento y luego Indice de búsqueda en el submenú.',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Los parámetros en esta página son solamente necesarios si sabe qué quiere algo diferente que no sea por defecto. Si no está seguro, simplemente pase a la siguiente página, ya que esos parámetros pueden ser cambiados desde el Panel de Administración.',
...
// TODO: Write some text on obtaining support
	...
	'UPDATE_TOPICS_POSTED_ERR'	=> 'Ha ocurrido un error mientras generaba información de topics posteados. Puede reintentar este paso en el Panel de Administración después de completar el proceso de conversión.',
...
$lang = array_merge($lang, array(
	...
	'CHECK_FILES_UP_TO_DATE'	=> 'De acuerdo a la base de datos su versión está actualizada. Puede proceder con la verificación de archivos para asegurarse de que todos est&acute;n verdaderamente actualizados con la última versión de phpBB.',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Una vez descargado, debería desempaquetar el archivo. Encontrará dentro los archivos modificados que necesitá subir al directorio raíz de su phpBB. Por favor, súbalos a sus respectivas ubicaciones. Despu&eacutes de que los haya subido todos, por favor verifique los archivos de nuevo con el otro botón de abajo.',
