...
*
* @package language
* @version $Id: posting.php,v 1.50.1 2007/12/24 Ronnie Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_SMILIES_EXPLAIN'	=> 'Uśmieszki lub emotikony to zazwyczaj małe, czasami animowane obrazki używane do wyrażania emocji czy uczuć. Tutaj możesz dodawać, usuwać i zmieniać uśmieszki, które użytkownicy mogą stosować w swoich postach i prywatnych wiadomościach. Możesz też zainstalować lub utworzyć pakiet uśmieszków.',
...
$lang = array_merge($lang, array(
	...
	'WORD'				=> 'Słowo',
	'WORD_ADDED'		=> 'Cenzorowane słowo zostało dodane.',
	'WORD_REMOVED'		=> 'Cenzorowane słowo zostało usunięte.',
	'WORD_UPDATED'		=> 'Cenzorowane słowo zostało zmienione.',
));
