...
*
* @package language
* @version $Id: styles.php,v 1.40.4 2008/02/21 Ronnie Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_STYLES_EXPLAIN'	=> 'Style składają sie z szablonu, tematu graficznego i zestawu obrazków.</p><p>Tutaj możesz edytować, eksportować i usuwać zainstalowane zestawy obrazków oraz importować i instalować nowe. Możesz też sprawdzać jak styl będzie wyglądał dzięki funkcji podglądu. Domyślny styl jest oznaczony gwiazdką (*). Wymieniona jest też łączna liczba użytkowników używających danego stylu (nie bierze to pod uwagę ewentualnego nadpisywania stylów użytkowników).',
	...
	'ACP_THEMES_EXPLAIN'	=> 'Tematy graficzne to style CSS i obrazki przez nie wykorzystywane. Zależnie od szablonu mogą albo ustalać jakiego koloru jest forum, albo nawet gdzie i w jaki sposób są umieszczone dane elementy forum.</p><p>Tutaj możesz edytować, eksportować i usuwać zainstalowane tematy oraz importować i instalować nowe.',
	...
	'ADD_THEME'				=> 'Dodaj temat graficzny',
	'ADD_THEME_EXPLAIN'		=> 'Tutaj możesz dodać temat graficzny. Zależnie od konfiguracji Twojego serwera i uprawnień plików, możesz mieć kilka dodatkowych możliwości, np. możesz mieć możliwość utworzenia tego tematu graficznego bazując na już istniejacym albo możliwość wgrania lub zaimportowania (z katalogu store) archiwum z tematem. Jeśli wgrasz lub zaimportujesz archiwum, możliwe będzie pobranie nazwy tematu z nazwy archiwum (aby to osiągnąć, pozostaw pole puste na nazwę).',
	...
	'CONFIRM_THEME_REFRESH'			=> 'Czy jesteś pewien, że chcesz odświeżyć wszystkie dane tematu graficznego zapisane w bazie danych za pomocą zawartości tematu systemie plików? Spowoduje to nadpisanie wszystkich zmian wykonanych poprzez edytor tematów (ponieważ zapisuje on dane w bazie danych).',
	'COPYRIGHT'						=> 'Copyright',
	'CREATE_IMAGESET'				=> 'Utwórz zestaw obrazków',
	'CREATE_STYLE'					=> 'Utwórz styl',
	'CREATE_TEMPLATE'				=> 'Utwórz szablon',
	'CREATE_THEME'					=> 'Utwórz temat graficzny',
	...
	'DELETE_THEME'				=> 'Usuń temat graficzny',
	'DELETE_THEME_EXPLAIN'		=> 'Tutaj możesz usunąć wybrany temat graficzny z bazy danych. Dodatkowo, jeśli masz uprawnienia, możesz też usunąć go z systemu plików. <strong>UWAGA! Nie ma tutaj opcji „Cofnij”!</strong> Przed usunięciem tematu zalecane jest wyeksportowanie go, aby móc go użyć w przyszłości',
	'DETAILS'					=> 'Szczegóły',
	...
	'EDIT_DETAILS_STYLE_EXPLAIN'		=> 'Tutaj możesz zmienić istniejący styl, w tym kombinację szablonu, tematu graficznego i zestawu obrazków, z której się on składa. Możesz też ustawić ten styl jako domyślny.',
	...
	'EDIT_DETAILS_THEME'				=> 'Zmień szczegóły tematu graficznego',
	'EDIT_DETAILS_THEME_EXPLAIN'		=> 'Tutaj możesz zmienić pewne szczegóły tematu graficznego, w tym jego nazwę. Możesz też zmienić sposób jego zapisywania - z bazy danych na system plików i odwrotnie. Opcja ta zależy od konfiguracji PHP i tego, czy temat graficzny jest zapisywalny przez serwer.',
	...
	'EDIT_THEME'						=> 'Zmień temat graficzny',
	'EDIT_THEME_EXPLAIN'				=> 'Tutaj możesz zmienić wybrany temat graficzny, jego kolory, obrazki itp.',
	'EDIT_THEME_STORED_DB'				=> 'Zapisanie zmodyfikowanego tematu graficznego w systemie plików było niemożliwe, więc temat graficzny jest teraz zapisywany w bazie danych.',
	'EDIT_THEME_STORE_PARSED'			=> 'Ten temat graficzny wymaga parsowania, przez co można go zapisywać tylko w bazie danych.',
	'EXPORT'							=> 'Eksportuj',
	...
	'IMAGE_WIDTH'				=> 'Szerokość obrazkia',
	...
	'INCLUDE_THEME'				=> 'Dołącz temat graficzny',
	...
	'INSTALL_THEME'				=> 'Zainstaluj temat graficzny',
	...
	'INSTALLED_THEME'			=> 'Zainstalowane tematy graficzne',
	...
	'NO_THEME'					=> 'Nie można znaleźć tematu graficznego w systemie plików.',
	...
	'NO_UNINSTALLED_THEME'		=> 'Nie znaleziono niezainstalowanych tematów graficznych.',
	'NO_UNIT'					=> 'Brak',
	...
	'ONLY_THEME'			=> 'Jest to ostatni pozostały temat graficzny, nie możesz go usunąć.',
	...
	'REPLACE_THEME'				=> 'Zamień temat graficzny na',
	'REPLACE_THEME_EXPLAIN'		=> 'Wybrany tutaj temat graficzny zastąpi ten, który usuwasz, we wszystkich  używających go stylach.',
	...
	'REQUIRES_THEME'			=> 'Ten styl wymaga, aby temat graficzny „%s” był zainstalowany.',

	'SELECT_IMAGE'				=> 'Wybierz obrazek',
	'SELECT_TEMPLATE'			=> 'Wybierz plik szablonu',
	'SELECT_THEME'				=> 'Wybierz plik tematu graficznego',
	...
	'SELECTED_THEME'			=> 'Wybrany temat graficzny',
	'SELECTED_THEME_FILE'		=> 'Wybrany plik tematu',
	...
	'STYLE_ERR_NO_IDS'			=> 'Musisz wybrać szablon, temat graficzny i zestaw obrazków dla tego stylu.',
	...
	'STYLE_EXPORT_EXPLAIN'		=> 'Tutaj możesz wyeksportować styl w formie archiwum. Styl nie musi zawierać wszystkich składników, ale przynajmniej jeden - tak. Na przykład, jeśli utworzyłeś nowy temat graficzny i zestaw obrazków dla często używanego szablonu, możesz po prostu wyeksportować ten temat graficzny i zestaw obrazków, pomijając szablon. Możesz też wybrać, czy bezpośrednio ściągnąć plik, czy umieścić go w katalogu store, aby później ściągnąć poprzez protokół FTP.',
	...
	'THEME_ADDED'				=> 'Dodano temat graficzny zapisywany w systemie plików.',
	'THEME_ADDED_DB'			=> 'Dodano temat graficzny do bazy danych.',
	'THEME_CLASS_ADDED'			=> 'Dodano nową klasę.',
	'THEME_DELETED'				=> 'Temat graficzny został usunięty.',
	'THEME_DELETED_FS'			=> 'Temat graficzny został usunięty z bazy danych, ale możliwe, że na dysku pozostały jego pliki.',
	'THEME_DETAILS_UPDATED'		=> 'Szczegóły tematu graficznego zostały zmienione.',
	'THEME_EDITOR'				=> 'Edytor tematu',
	...
	'THEME_ERR_NAME_CHARS'		=> 'Nazwa tematu graficznego może zawierać tylko litery alfabetu łacińskiego, cyfry, -, +, _ oraz spację.',
	'THEME_ERR_NAME_EXIST'		=> 'Temat graficzny o tej nazwie już istnieje.',
	'THEME_ERR_NAME_LONG'		=> 'Nazwa tematu graficznego nie może mieć więcej niż 30 znaków.',
	'THEME_ERR_NOT_THEME'		=> 'Podane archiwum nie zawiera prawidłowego tematu graficznego.',
	'THEME_ERR_REFRESH_FS'		=> 'Ten temat graficzny jest zapisywany w systemie plików, więc nie ma potrzeby go odświeżać.',
	'THEME_ERR_STYLE_NAME'		=> 'Musisz podać nazwę tematu graficznego.',
	'THEME_FILE'				=> 'Plik tematu',
	'THEME_EXPORT'				=> 'Eksportuj tematy graficzne',
	'THEME_EXPORT_EXPLAIN'		=> 'Tutaj możesz wyeksportować temat graficzny w formie archiwum. Archiwum będzie zawierać wszystkie dane potrzebne do zainstalowania tematu graficznego na innym forum. Możesz też wybrać, czy bezpośrednio ściągnąć plik, czy umieścić go w katalogu store, aby później ściągnąć poprzez protokół FTP.',
	'THEME_EXPORTED'			=> 'Temat graficzny został wyeksportowany i zapisany w %s.',
	'THEME_LOCATION'			=> 'Zapisz temat graficzny w',
	'THEME_LOCATION_EXPLAIN'	=> 'Obrazki są zawsze zapisywane w systemie plików.',
	'THEME_NAME'				=> 'Nazwa tematu graficznego',
	'THEME_REFRESHED'			=> 'Temat graficzny został odświeżony.',
	'THEME_UPDATED'				=> 'Temat graficzny został zmieniony.',
	...
	'UNINSTALLED_THEME'		=> 'Niezainstalowane tematy graficzne',
